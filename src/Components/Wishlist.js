    ...
    return (
        <>
            ...
            {wishlistProducts.length < 1 && (
                <div className='container-fluid' style={{height:500, marginTop:20}}>
                <p>
                    Hi {user}, your trolley is pretty clear.
                </p>
                
                <p>
                    Head back to the shelves and pick something nice, will ya?
                </p>
