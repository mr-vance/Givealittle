  ...
  return (
    <>
        ...
        <Card.Body>
            ...
            <Form onSubmit={handleSubmit}>
              <Form.Group id='name'>
                ...
                <Form.Group id='drivernumber'>
                    <Form.Label>Driver License Number</Form.Label>
                    <Form.Control type='number' ref={drivernumberRef} required/>
                </Form.Group>
                <Form.Group id='email'>
      ...
      <div className='w-100 text-center mt-2'>
        Already have an account? <Link to='/driverlogin'>Login In</Link>
      </div>
    </>
  )
}
